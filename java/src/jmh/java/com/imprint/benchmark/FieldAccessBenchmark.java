...
public class FieldAccessBenchmark {
    ...
    @Benchmark
    public void getRawBytesFirstField(Blackhole bh) throws Exception {
        var rawBytes = denseRecord.getRawBytes(1);
        bh.consume(rawBytes);
    }

    @Benchmark
    public void getRawBytesMiddleField(Blackhole bh) throws Exception {
        var rawBytes = denseRecord.getRawBytes(50);
        bh.consume(rawBytes);
    }

    @Benchmark
    public void getRawBytesLastField(Blackhole bh) throws Exception {
