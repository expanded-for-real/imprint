...
public class SerializationBenchmark {
    ...
    @Benchmark
    public void serializeSmallRecord(Blackhole bh) throws Exception {
        ByteBuffer result = smallRecord.serializeToBuffer();
        bh.consume(result);
    }

    @Benchmark
    public void serializeMediumRecord(Blackhole bh) throws Exception {
        ByteBuffer result = mediumRecord.serializeToBuffer();
        bh.consume(result);
    }

    @Benchmark
    public void serializeLargeRecord(Blackhole bh) throws Exception {
